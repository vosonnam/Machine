...
namespace xqmachine
{
    ...
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var fromEmail = new MailAddress(ConfigurationManager.AppSettings["Email:Id"], ConfigurationManager.AppSettings["Email:Name"]);
            ...
            var smtp = new SmtpClient
            {
                ...
                Credentials = new NetworkCredential(fromEmail.Address, ConfigurationManager.AppSettings["Email:Password"])
            };
            using (var SendMessage = new MailMessage(fromEmail, toEmail)
            {
