...
$(document).ready(function () {
    ...
    $(document.body).on("click", 'input[name="option_payment"]', function (e) {
        $('.list-content li').removeClass('active');
        $(e.currentTarget).parent().parent('li').addClass('active');
    });

    $(document.body).on("click", '#popupcreateaddress', function (e) {
...
console.log($('#closemodal3, #huymodal3'));
$('#closemodal3, #huymodal3').click(function () {
